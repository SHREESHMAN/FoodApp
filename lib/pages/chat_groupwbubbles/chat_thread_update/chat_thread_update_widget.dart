                              ...
                              Container(
                                ...
                                child: Padding(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      if (widget.chatMessagesRef?.itemstatus !=
                                              null &&
                                          widget.chatMessagesRef?.itemstatus !=
                                              '')
                                        Align(
                                          alignment:
                    ...
                    Container(
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          crossAxisAlignment: CrossAxisAlignment.end,
                          children: [
                            if ((widget.chatMessagesRef?.itemstatus != null &&
                                    widget.chatMessagesRef?.itemstatus != '') &&
                                (widget.chatMessagesRef?.itemstatus == 'wait'))
                              Icon(
