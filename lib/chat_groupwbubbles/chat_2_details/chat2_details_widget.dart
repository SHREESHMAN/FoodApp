...
class _Chat2DetailsWidgetState extends State<Chat2DetailsWidget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      if (widget.item != null) {
        setState(() {
          _model.chatThreadComponentModel.textController?.text =
              valueOrDefault<String>(
            functions.messagemaker(FFAppState().foodItem[widget.item!]),
        ...
        await chatMessagesRecordReference.set(createChatMessagesRecordData(
          ...
          image: FFAppState().foodItem[widget.item!].img,
          itemstatus: 'wait',
          itemspecs: updateFoodItemStruct(
            FoodItemStruct(),
        ...
        await widget.chatRef!.reference.update(createChatsRecordData(
          lastMessageTime: getCurrentTimestamp,
          lastMessageSentBy: currentUserReference,
          lastMessage: '[ User Sent Item ]',
        ));
        setState(() {
