...
class InboxWidget extends StatefulWidget {
  ...
  final List<UsersRecord>? allbanks;
    ...
    return StreamBuilder<List<UsersRecord>>(
      stream: queryUsersRecord(
        queryBuilder: (usersRecord) => usersRecord.where(
          'type',
          isEqualTo: UserType.Bank.serialize(),
        ),
      ),
      builder: (context, snapshot) {
        ...
        List<UsersRecord> inboxUsersRecordList = snapshot.data!;
                ...
                children: [
                      ...
                      Padding(
                        ...
                        child: Text(
                          valueOrDefault<String>(
                            inboxUsersRecordList.length.toString(),
                            '0',
                          ),
                          style:
                  ...
                  Expanded(
                    child: Padding(
                      ...
                      child: Builder(
                        builder: (context) {
                          final bank = inboxUsersRecordList.toList();
